# react-native-meta-audience-sdk [![npm version][version-badge]][package]
...
```bash
yarn add react-native-meta-audience-sdk
```

or npm:

```bash
npm install --save react-native-meta-audience-sdk
```
...
```bash
$ react-native link react-native-meta-audience-sdk
```
...
```sh
expo install react-native-fbsdk-next react-native-meta-audience-sdk
```
...
```js
import { NativeAdsManager } from 'react-native-meta-audience-sdk';
...
```js
import { AdChoicesView } from 'react-native-meta-audience-sdk';
...
[version-badge]: https://img.shields.io/npm/v/react-native-meta-audience-sdk.svg?style=flat-square
[package]: https://www.npmjs.com/package/react-native-meta-audience-sdk
